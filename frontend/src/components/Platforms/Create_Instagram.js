...
//         axios
//             .get('http://localhost:5000/api/followers_likes_insta')
//             .then((response) => {
...
//         axios
//             .get('http://localhost:5000/api/instapackages')
//             .then((response) => {
...
//                 <form className='form-group' method="post" action={`http://localhost:5000/CreateInstagram`} >
//                     <div className='form-group mt-3'>
//                         <Input type="text" className='form-control' name="instausername" placeholder="Instagram" required />
//                     </div>
//                     <div>
//     Username:
...
// export default Create_Instagram;
